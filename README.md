...
| # | アイデア | 状態 | プロジェクト |
|---|---------|------|------------|
| 1 | まちなか謎解きアドベンチャー — NFCタグでパズルを解く | ⬜ 未作成 | — |
...
| 3 | Spotlight で完結するミニ家計簿 — アプリ不要の家計管理 | ⬜ 未作成 | — |
...
| 2 | VoiceMorph — リアルタイムボイスチェンジャー | ⬜ 未作成 | — |
...
| 3 | SynthLab — ビジュアル・シンセサイザー学習アプリ | ⬜ 未作成 | — |
...
| 2 | GridPulse — 電力グリッドの鼓動を可視化するリビングアート | ⬜ 未作成 | — |
| 3 | WattWise — 家族で楽しむ節電チャレンジ | ⬜ 未作成 | — |
...
| 3 | MeetingLens — 会議コスト可視化＆最適化ツール | ⬜ 未作成 | — |
| 4 | LifeRewind — カレンダーベースのライフログ＆回顧録 | ⬜ 未作成 | — |
...
| 2 | TypeGuard — タイピングで見つける神経疾患の兆候 | ⬜ 未作成 | — |
| 3 | LightLife — 光環境と生活リズムの関係を解明 | ⬜ 未作成 | — |
...
| # | アイデア | 状態 | プロジェクト |
|---|---------|------|------------|
| 1 | SoraNavi — AI写真撮影スポットアドバイザー | ⬜ 未作成 | — |
| 2 | KiseKae — 天気連動バーチャルコーディネーター | ⬜ 未作成 | — |
...
| # | アイデア | 状態 | プロジェクト |
|---|---------|------|------------|
| 1 | MoodBoard Widget — ホーム画面が日記になる | ⬜ 未作成 | — |
